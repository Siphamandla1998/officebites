...
export default function Checkout() {
  ...
  const [guestDetails, setGuestDetails] = useState({ name: "", contact: "" });
  ...
  const validateGuest = () => {
    ...
    if (!guestDetails.contact.trim()) next.contact = "Enter a phone number or email we can reach you on";
    setErrors(next);
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      const order = await orderService.createOrder({
        ...
        guestContact: isAuthenticated ? null : guestDetails.contact,
