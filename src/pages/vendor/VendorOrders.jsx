          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div>
                ...
                <p className="font-medium text-ink">{selected.customerContact || "Not provided"}</p>
              </div>
              <div>
              ...
              <div className="col-span-2">
                <p className="text-xs text-ink-muted">Delivery location</p>
                <p className="font-medium text-ink">{selected.deliveryLocation || "Not provided"}</p>
              </div>
              <div>
