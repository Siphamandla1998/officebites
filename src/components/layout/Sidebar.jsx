...
export default function Sidebar({ tabs, open, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:sticky top-0 z-50 lg:z-auto h-screen w-72 shrink-0 bg-ink text-paper flex flex-col pt-[env(safe-area-inset-top)] transition-transform duration-200 ${
