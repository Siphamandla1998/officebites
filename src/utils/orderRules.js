...
export function nextOrderableDate() {
  ...
  // If we're past today's 19:00 cutoff for "tomorrow",
...
/**
 * Split a single multi-vendor cart into
...
// uppercase, no 0/O/1/I/L — avoids characters
// customers commonly misread when reading a
// ticket code off a screen.
const TICKET_ALPHABET =
  "23456789ABCDEFGHJKMNPQRSTUVWXYZ";

/**
 * Cryptographically random, customer-facing
 * order code — e.g. "OB-7F42KQ".
 *
 * 32^6 ≈ 1.07 billion combinations.
 *
 * Uses a CSPRNG rather than Math.random().
 */
